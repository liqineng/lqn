...
<link href="/qn/statics/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/theme.min.css" rel="stylesheet">
<link href="/qn/statics/simpleboot/css/simplebootadmin.css" rel="stylesheet">
<link href="/qn/statics/simpleboot/font-awesome/4.2.0/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
<!--[if IE 7]>
	<link rel="stylesheet" href="/qn/statics/simpleboot/font-awesome/4.2.0/css/font-awesome-ie7.min.css">
<![endif]-->
<link rel="stylesheet" href="/qn/statics/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/qn/statics/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				<a href="/qn/index.php?g=admin&m=index&a=index" class="brand"> <small> 
				<img src="/qn/statics/images/icon/logo-18.png">
						ThinkCMF 后台
				</small>
				</a>
				<div class="pull-left nav_shortcuts" >
					...
					<a class="btn btn-small btn-warning" href="/qn/" title="前台首页" target="_blank">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="/qn/statics/images/icon/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>">
	...
	<script src="/qn/statics/js/jquery.js"></script>
	<script src="/qn/statics/simpleboot/bootstrap/js/bootstrap.min.js"></script>
	<script>
	...
	<script src="/qn/tpl_admin/simpleboot/assets/js/index.js"></script>
